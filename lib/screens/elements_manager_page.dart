...
class ElementsManagerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final elementsRef = FirebaseFirestore.instance
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snap) {
          ...
          final elements = (data != null && data['elements'] is List)
              ? List.from(data['elements'] as List)
              : [];
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final pos =
                          el['position'] as Map<String, dynamic>? ??
                          {'x': 0.5, 'y': 0.5};
                            ...
                            IconButton(
                              ...
                              onPressed: () async {
                                try {
                                  ...
                                  final imageUrl =
                                      frameData?['imageUrl'] as String? ?? '';
                                  // ensure we pass a Map<String, dynamic>
                                  final typed = Map<String, dynamic>.from(el);
                                  debugPrint(
                                    'ElementsManager: opening editor for element: $typed',
                                  );
                                  await Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (_) => AddElementPage(
                                        frameId: frameId,
                                        frameImageUrl: imageUrl,
                                        existingElement: typed,
                                      ),
                                    ),
                                  );
                                } catch (e) {
