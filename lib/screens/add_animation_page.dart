...
class _AddAnimationPageState extends State<AddAnimationPage> {
  ...
  void initState() {
    ...
    if (ex != null) {
      if (ex['rotation'] is num)
        _rotationDeg = (ex['rotation'] as num).toDouble();
      ...
      if (ex['translateX'] is num)
        _translateX = (ex['translateX'] as num).toDouble();
      if (ex['translateY'] is num)
        _translateY = (ex['translateY'] as num).toDouble();
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.existing != null ? 'Edit Animation' : 'Add Animation',
        ),
      ),
      body: Padding(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    if (_frameIntrinsicW != null &&
                        _frameIntrinsicH != null &&
                        _frameIntrinsicW! > 0 &&
                        _frameIntrinsicH! > 0) {
                    ...
                    final base = (frameDispW < frameDispH)
                        ? frameDispW
                        : frameDispH;
                    ...
                    final centerX = (nx * frameDispW).clamp(
                      elemW / 2.0,
                      frameDispW - elemW / 2.0,
                    );
                    final centerY = (ny * frameDispH).clamp(
                      elemH / 2.0,
                      frameDispH - elemH / 2.0,
                    );
                    ...
                    return Stack(
                      children: [
                        ...
                        Positioned.fill(
                          child: Center(
                            child: widget.frameImageUrl != null
                                ? Image.network(
              ...
              Row(
                children: [
                  ...
                  Text('${_rotationDeg.toStringAsFixed(0)}\\u00b0'),
                ],
              ),
              Row(
                children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Slider(
                      ...
                      min: -45,
                      max: 45,
                      onChanged: (v) => setState(() => _skewXDeg = v),
                    ),
                  ),
                  Text('${_skewXDeg.toStringAsFixed(0)}\\u00b0'),
                ],
              ),
              Row(
                children: [
                  ...
                  Expanded(
                    child: Slider(
                      ...
                      min: -45,
                      max: 45,
                      onChanged: (v) => setState(() => _skewYDeg = v),
                    ),
                  ),
                  Text('${_skewYDeg.toStringAsFixed(0)}\\u00b0'),
                ],
              ),
              Row(
                children: [
                  ...
                  Expanded(
                    child: Slider(
                      ...
                      min: -0.5,
                      max: 0.5,
                      onChanged: (v) => setState(() => _translateX = v),
                    ),
                  ),
                  Text(_translateX.toStringAsFixed(2)),
                ],
              ),
              Row(
                children: [
                  ...
                  Text(_translateY.toStringAsFixed(2)),
                ],
              ),
              Row(
                children: [
